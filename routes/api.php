...
// ✅ PUBLIC BLOG ROUTES — MUST COME FIRST
Route::get('/blogs/public', [BlogController::class, 'publicIndex']);
Route::get('/blogs/public/{slug}', [BlogController::class, 'show']);

// Admin / generic blog routes
...
Route::options('/header-settings', function () {
    return response('', 200);
});
Route::options('/footer-settings', function () {
    return response('', 200);
});
